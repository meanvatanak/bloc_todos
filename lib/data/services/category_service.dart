...
class CategoryService {
  Future<CategoryResModel> getAllCategory() async {
    String errorMessage = '';
    try {
      ...
      final url = Uri.parse('$baseUrl/api/todo-categories?per_page=100&page=1');
      ...
      if (response.statusCode == 200) {
        // print(responseJson);
        return CategoryResModel.fromJson(responseJson);
      } else {
  ...
  Future<bool> createCategory(CreateTaskReqModel reqModel) async {
    String errorMessage = '';
    try {
      final prefs = await SharedPreferences.getInstance();
      final userInfo = prefs.getString(userInfoKey);
